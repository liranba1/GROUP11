...
<a href="search_order.php"><p align="right">Back to Search</p></a>
</center>
<?php if (!isset($_POST['sorder'])) {?>
	<br><br><br><br><br>
	<center>
	<form action="search_order.php" method="post">
	<br>
	<table>
	<th colspan=3>Search Order</th>
	<tr>
	<td>Enter Order ID:</td>
	<td><input type="text" name="id" /></td>
	</tr>
	<td><input type="submit" name="sorder"></td>
	</form>
<?php } else {?>
...
<?php 
	if(isset($_POST['sorder']))
	{
		...
		<?php }?>
			...
			<tr><td colspan=8>
			<?php echo 'Payment info: '; echo 'Credit Card:'; echo $card; echo ', cvv: '; echo $cvv; echo ' ,exp: '; echo $exp; echo ' , Total Paid: '; echo $t; echo '$';?>
			</tr></td>
			<tr><td colspan=8>
